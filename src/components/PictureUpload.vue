<template>
  <div>
    ...
    />
    <el-button id="browse_button" type="primary">Select Image</el-button>
    <br/>
    <br/>
    <el-tag type="info">"Image Preview Area"</el-tag>
        ...
        <el-card :body-style="{ padding: '0px' }">
          ...
          <div style="padding: 5px; display: flex">
              <div style="flex: 3; display: flex; justify-content:center;align-items:center;">
                <span v-if="image.file.status === 1" style="color: aqua;">"Preparing to Upload"</span>
                <span v-if="image.file.status === 4" style="color: brown">"Upload Failed"</span>
                <span v-if="image.file.status === 5" style="color: chartreuse">Uploaded</span>
